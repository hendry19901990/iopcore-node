...
Iop.prototype.getAPIMethods = function() {
  var methods = [
    ...
    ['getListTransactions', this, this.getListTransactions, 0],
...
Iop.prototype.importAddress = function(address, callback) {
	...
	if (readyImp){
		...
		self._tryAllClients(function(client, done) {
		  client.importAddress(address, address, false, function(err, response) {
            if (err) {
...
Iop.prototype.getBalance = function(address, callback) {
	var self = this;
    self._tryAllClients(function(client, done) {
		client.getBalance(address, 0, function(err, response) {
          if (err) {
            return done(self._wrapRPCError(err));
          }
          done(null, response.result);
...
/**
 * Will get all last recent transaction as a iopcore Transaction. Results include the mempool.
 * @param {Function} callback
 */
Iop.prototype.getListTransactions = function(callback) {
