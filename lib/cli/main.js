...
var iopcorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = iopcorenode.version;
  var create = iopcorenode.scaffold.create;
  var add = iopcorenode.scaffold.add;
  var start = iopcorenode.scaffold.start;
  var remove = iopcorenode.scaffold.remove;
  var callMethod = iopcorenode.scaffold.callMethod;
  var findConfig = iopcorenode.scaffold.findConfig;
  var defaultConfig = iopcorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-c, --config <dir>', 'Specify the directory with IoP Node configuration')
    .option('-d, --daemon', 'Make iopcore-node a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `iopcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ iopcore-node add wallet-service');
      console.log('    $ iopcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ iopcore-node remove wallet-service');
      console.log('    $ iopcore-node remove insight-api');
      console.log();
    });
